...
class NowcoderSpider(scrapy.Spider):
    ...
    start_urls = [
        # 内推
        ('https://www.nowcoder.com/search?type=post&query=%E5%86%85%E6%8E%A8&page={}'.format(i)) \
        for i in range(1, 4)] \
    + [ # 补招
        ('https://www.nowcoder.com/search?query=%E8%A1%A5%E6%8B%9B&type=post&page={}'.format(i)) \
        for i in range(1, 4)]
